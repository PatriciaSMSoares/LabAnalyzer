...
class PoreSizeDistCAnalysis(BaseAnalysis):
    analysis_id = 'psdC'
    display_name = 'Cumulative Pore Size Distribution (V vs Pore Width)'
    ...
    def render(self, datasets, config, figure, ax=None):
        ...
        for ds in datasets:
            ...
            y_col = _find_col(df, ['v', 'volume', 'cumulative volume'])
        ...
        ax.set_ylabel('Cumulative Volume (cm³/g)')
        ax.set_title(f'Cumulative Pore Size Distribution ({method})')
